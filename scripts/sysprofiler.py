...
os.system("echo Virtosh SYSTEM REPORT "+str(datetime.today().strftime('%d-%m-%Y %H:%M:%S'))+" > ./logs/SPT_"+logTime+".log")
...
os.system("echo Virtosh software environment. "+" >> ./logs/SPT_"+logTime+".log")
os.system("echo "+" >> ./logs/SPT_"+logTime+".log")
...
if os.path.exists("./blobs/user/USR_CFG.apb"):
    ...
    if os.path.exists("./"+apFilePath):
        ...
        with open(("./"+apFilePath),"r") as file:
            ...
            ultmosGenVer = apFileRead.partition("VIRTOSH=")[2]
...
if branch != "main":
    ...
    warnings.append(("This version of Virtosh is from the "+branch+" branch, which"))
...
if upgraded == True:
    ...
    warnings.append(("This copy of the Virtosh repository was originally cloned"))
...
if internal == True:
    ...
    warnings.append(("This Virtosh setup appears to be an internal"))
...
if apFilePath is not None:
    ...
    cpydProfile(" ")
    cpydProfile(("Virtosh     : "+str(ultmosGenVer)))
