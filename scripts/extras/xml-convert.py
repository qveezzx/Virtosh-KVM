...
def startup():
    ...
    print("   by",color.BOLD+"qveezzx"+color.END)
...
if detectChoiceM == "1":
    ...
    os.system('xdg-open https://github.com/qveezzx/Virtosh-KVM/wiki/XML-Converter > /dev/null 2>&1')
    time.sleep(6)
    clear()
    startup()


#https://github.com/qveezzx/Virtosh-KVM/wiki/XML-Converter