...
def startup():
    ...
    if detected == 0:
        ...
        #print(color.BOLD+"\n"+"Profile:"+color.END,"https://github.com/qveezzx")
        #print(color.BOLD+"   Repo:"+color.END,"https://github.com/qveezzx/Virtosh-KVM")
...
#    os.system('xdg-open https://github.com/qveezzx/Virtosh-KVM > /dev/null 2>&1')
#    time.sleep(6)
#    clear()
...
#    os.system('./scripts/kunihir0/cleanup.py')
    ...
    print("   Continue in your browser\n")
    print("\n   The tool have attempted to open the new issue form in\n   your default browser. Please be patient.\n\n   You will be returned to the extras menu in 5 seconds.\n\n\n\n\n")
    os.system('xdg-open https://github.com/qveezzx/Virtosh-KVM/issues/new > /dev/null 2>&1')
    time.sleep(6)
    clear()
    os.system('./scripts/extras.py')
