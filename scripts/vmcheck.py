...
if detected == 1:
   ...
   print("\n   Determined that it's more than likely that \n   you're using a virtual machine to run this. The script won't\n   stop you, but by continuing you should NOTE that the OSX WILL perform much WORSE."+color.END)
